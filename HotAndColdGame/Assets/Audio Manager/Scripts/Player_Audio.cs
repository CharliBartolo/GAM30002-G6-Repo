    ...
    //Current volume is not currently set to match temperature value, This will need to be further implemented depending on how we want it to work
{
    ...
    {
        FindObjectOfType<AudioManager>().Spawn(this.gameObject ,"Cave");
        FindObjectOfType<AudioManager>().Spawn(this.gameObject, "Main");
        FindObjectOfType<AudioManager>().Spawn(this.gameObject, "Ice");
        FindObjectOfType<AudioManager>().Spawn(this.gameObject, "Heat");
